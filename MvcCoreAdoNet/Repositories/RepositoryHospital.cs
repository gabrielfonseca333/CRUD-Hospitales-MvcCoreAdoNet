...
namespace MvcCoreAdoNet.Repositories
{
    public class RepositoryHospital
    {
        ...
        public Hospital FindHospital(int  id)
        {
            ...
            this.com.Parameters.AddWithValue("@idhospital", id);
            this.com.CommandType = System.Data.CommandType.Text;
            this.com.CommandText = sql;
            this.cn.Open();
            this.reader = this.com.ExecuteReader();
        ...
        public void CreateHospital
            (int id, string nombre, string direccion, string telefono, int camas)
        {
        ...
        public void EditHospital(int id, string nombre, string direccion, string telefono, int camas)
        {
